class ReviewFilesController < ApplicationController
  ...
  #  @view_variables = Hash.new
    @participant = AssignmentParticipant.find(params[:participant_id])
  #  @view_variables = {:@participant => AssignmentParticipant.find(params[:participant_id])}
  ...
  #  @view_variables = @view_variables.merge(:@current_review_file => older_file)
  ...
  #  @view_variables = @view_variables.merge(@version_fileId_map)
    ...
    @offsetswithcomments_file2 = []     # Can be renamed to offsetswithcomments_right_file
   ...
   # @view_variables = @view_variables.merge(@shareObj)
    @file_on_left = files[:@older_file]
    @file_on_right = files[:@newer_file]
    #View variables
   # @view_variables = @view_variables.merge(:@file_on_left => files[:@older_file])
   # @view_variables = @view_variables.merge(:@file_on_right => files[:@newer_file])
   ...
   # @view_variables = @view_variables.merge(@highlight_cell_left_file)
   ...
   # @view_variables = @view_variables.merge(@highlight_cell_right_file)
  end
